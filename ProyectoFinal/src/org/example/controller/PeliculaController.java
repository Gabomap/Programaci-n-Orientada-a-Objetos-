    ...
    private void buscar() {
        ...
        for (int i = 0; i < listaPeliculas.size(); i++) {
            ...
            if (pelicula.getTitulo()
                    .equalsIgnoreCase(titulo.trim())) {

                vista.getTablaPeliculas()
                ...
                vista.getChkFavorita().setSelected(
                        pelicula.isFavorita());

                String formato = pelicula.getFormato();

                vista.getRbDVD().setSelected(
                        formato.equals("DVD"));

                vista.getRbBluRay().setSelected(
                        formato.equals("BluRay"));

                vista.getRbStreaming().setSelected(
                        formato.equals("Streaming"));
